...
class OmniSVDataset(Dataset):
    """
    Dataset loader for triplet features.
    """
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # Consistent with previous logic to avoid crash
...
def run_cross_validation(args):
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(record_ids)):
        ...
        # Internal split: 80% split into Train (70% total) and Val (10% total)
        ...
        best_val_f1 = 0.0
        # Model path passed via argparse with fold index
        ...
        # Final Evaluation on Test Set using best weights for this fold
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Omni-SV 5-Fold Cross Validation")
    
    # Core Data Path Parameters
    parser.add_argument("--label_json", type=str, required=True, help="Path to labels JSON")
    parser.add_argument("--syn_dir", type=str, required=True, help="Directory for syntactic features")
    parser.add_argument("--evo_dir", type=str, required=True, help="Directory for evolutionary features")
    parser.add_argument("--omics_dir", type=str, required=True, help="Directory for functional features")
    
    # Model Saving Parameters
    parser.add_argument("--save_dir", type=str, default="./checkpoints", help="Directory to save weights")
    parser.add_argument("--model_name", type=str, default="OmniSV_Best", help="Base name for the saved model files")
    ...
    # MGO Strategy Weights (Section 4.6)
