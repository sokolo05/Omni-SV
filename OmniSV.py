...
def main():
    ...
    # STAGE 2: Multi-Granularity Optimization Training
        ...
        # Fixed: Read features directly from the preprocessed directory to avoid missing subfolder errors
    ...
    # STAGE 3: Downstream Filtering and VCF Revision
        ...
        # Fixed: Aligned the predictor interface with the trainer to ensure multimodal features load properly
